...
public class OrdineBean implements Serializable{
	...
	public OrdineBean(int id, Date dataOrdine, Date dataConsegna, Time orarioOrdine, Time orarioConsegna, ProdottoBean prodotto, double prezzoProdotto, int quantitaProdotto, int ivaProdotto, String indirizzo, UtenteBean utente, CartaBEAN carta) {
		this.id = id;
	...
	public OrdineBean(int id, Date dataOrdine, Time orarioOrdine, ProdottoBean prodotto, double prezzoProdotto, int quantitaProdotto, int ivaProdotto, String indirizzo, UtenteBean utente, CartaBEAN carta) {
		this.id = id;
		this.dataOrdine = dataOrdine;
		this.orarioOrdine = orarioOrdine;
		this.prodotto = prodotto;
