...
<body>
	...
	<div class=page>
        ...
        <div class="scelta">
        	...
        	<label class=opt id=modifica>MODIFICA PRODOTTO</label>
        		<form action="ModificaProdotto" class=mod id=mod onSubmit="return validateModifica();">
        			...
        			<label for=prezzo>Prezzo: </label><input type=number step=0.01 style="margin-bottom:8px;" placeholder="Prezzo" min=0 id=prezzoModifica name=prezzo required>
        ...
        <p id=error style="color:red; text-align:center">ERRORE: INSERISCI UN CODICE VALIDO!</p>
     </div>
